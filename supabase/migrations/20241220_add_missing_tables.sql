-- Add missing tables and functionality for academic platform
-- Migration: 20241220_add_missing_tables
...
-- Update attendance_sessions status column
ALTER TABLE public.attendance_sessions
ALTER COLUMN status TYPE TEXT,
ADD CONSTRAINT attendance_sessions_status_check CHECK (status IN ('active', 'expired', 'cancelled'));
